...
static constexpr i2c_dt_spec mpu = I2C_DT_SPEC_GET(DT_ALIAS(mpu6050));
static I2cSpec imuSpec(reinterpret_cast<uintptr_t>(&mpu));
...
int main()
{
    Application app(adcSpec, greenLedSpec, yellowLedSpec, redLedSpec, imuSpec, ledSpec);
